...
namespace RoadDemo
{
    ...
    public sealed class DemoExhaust : MonoBehaviour
    {
        ...
        const float IdleRate = 7f;
        const float CruiseRate = 4f;
        const float AccelRate = 22f;
        ...
        const float PuffWide = 0.13f;
        const float PuffGrow = 2.1f;
        const float PuffLifeLo = 0.7f;
        const float PuffLifeHi = 1.4f;
        const float PuffSpeed = 0.55f;
