...
namespace RoadDemo
{
    ...
    public partial class CrewOverlay : MonoBehaviour
    {
        ...
        void ReadRightClick(Mouse mouse)
        {
            ...
            // Bikes have no boarding order of their own: a right-click hands this
            // outfit machine to the selected crew, just as it does when the car under
            // the pointer belongs to another branch.
