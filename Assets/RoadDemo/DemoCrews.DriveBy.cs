...
namespace RoadDemo
{
    ...
    public partial class DemoCrews
    {
        ...
        /// The street uses this to decide whether a right-click may hand its keys to
        /// the selected crew.</summary>
        ...
        /// The ledger remains the authority, exactly as it is for AssignCar; the next
        /// bind moves the visible machine to the crew named by the new deed.</summary>
